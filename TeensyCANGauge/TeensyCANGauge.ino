...
struct DATA {
  ...
  // Base ID + 1  
  DATA rpm = {"RPM",1,0,0,16,1,"",0,7000};
  ...
  // Base ID + 4
  DATA afr = {"AFR",4,0,0,16,0.001,"",10,20};
  DATA oil = {"Oil",4,2,0,16,0.03,"kPa"};
  DATA vvt = {"VVT",4,4,0,16,0.02,"deg"};
  DATA battery = {"Battery",4,6,0,16,0.001,"V",10,16};
  ...
  DATA demo = {"Demo",0,0,0,0,1,"demo",0,100,0};
...
void setupSensorData(CAN_message_t inMsg){
  switch (inMsg.id){
      ...
      case (baseID + 0):
        warningCount.val = getSensorData2(inMsg,warningCount);
        lastError.val = getSensorData2(inMsg,lastError);
...
void printSensor2(struct DATA &channel, struct DATA &channel2){ 
    ...
    u8g2.setFont(u8g2_font_helvB24_tf );
    printText((channel.val),3,45,25); 
    printText((channel2.val),3,45,55);
}
...
void printSensor3(struct DATA &channel){
    u8g2.setFont(u8g2_font_8x13B_tf);
    printText(channel.chName,1,0,30);
    
    u8g2.setFont(u8g2_font_helvB24_tf );
    printText(String(channel.val),3,50,55);
   
    drawBarGraph(0,0,channel.val,channel.minimum,channel.maximum);
}

void printSensor4(struct DATA &channel, struct DATA &channel2){
  drawBarGraph(0,0,channel.val,channel.minimum,channel.maximum);
  u8g2.setFont(u8g2_font_8x13B_tf);
  printText(channel.chName,1,0,30);
  printText(channel.val,1,45,30);

  drawBarGraph(0,55,channel2.val,channel2.minimum,channel2.maximum);
  u8g2.setFont(u8g2_font_8x13B_tf);
  printText(channel2.chName,1,0,45);
  printText(channel2.val,1,45,45);
}
...
CAN_message_t inMsg;
  ...
  // Update values contained in the reieved message
    ...
    case 2:
      ...
      break;
    case 3:
      printSensor4(iat,mapP);
      break;
    case 4:
      printSensor4(tps1,afr);
      break;
    case 5:
      printSensor2(warningCount,lastError);
      break;
    }
    ...
    case 1:
      ...
      case 0:
        ...
        break;
      case 1:
        printSensor2(demo,demo);
        break;
      case 2:
        printSensor3(demo);
        break;
      case 3:
        printSensor4(demo,demo);
        break;
      }
